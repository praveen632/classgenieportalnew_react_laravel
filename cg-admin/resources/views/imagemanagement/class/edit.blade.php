...
<div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Add Class Image</h3>&nbsp;&nbsp;<a class="btn btn-success search_btn-add  add_newbtn" href="<?php echo url('/imagemanagement/class')?>">View List</a>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
     {!! Form::model($edit,['method' => 'PATCH','route'=>['imagemanagement.class.update',$edit->id], 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data', 'name'=> 'classimg_create', 'id'=>'classimg_create']) !!}
     {!! csrf_field() !!}        
      <div class="box-body">
