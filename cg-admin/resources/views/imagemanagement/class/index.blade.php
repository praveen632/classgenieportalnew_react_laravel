...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">Class Image Magement</h3>&nbsp;&nbsp;<a class="btn btn-success search_btn-add  add_newbtn" href="<?php echo url('/imagemanagement/class/create')?>">Add Class Image</a>
  </div>
  {!! csrf_field() !!}
   <div class="col-md-12">
        @if(Session::has('message'))
          <div class="alert alert-success" style="text-align:center;">
            <a href="./class" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              ...
              foreach($imagemang as $row)
              {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php if($row->status == 1){?>
                    {{ Form::open(array('route' => array('imagemanagement.class.destroy', $row->id), 'method' => 'delete')) }}
